...
go run hack/python-sdk/main.go V1 0.1 > ${SWAGGER_V1_CODEGEN_FILE}
...
go run hack/python-sdk/main.go V2 0.1 > ${SWAGGER_V2_CODEGEN_FILE}
...
java -jar ${SWAGGER_CODEGEN_JAR} generate -i ${SWAGGER_V2_CODEGEN_FILE} -g python-legacy -o ${SDK_OUTPUT_PATH}/v2 -c ${SWAGGER_CODEGEN_CONF}
